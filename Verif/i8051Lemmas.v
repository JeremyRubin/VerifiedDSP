...
(** i8051Lemmas.v. This file holds lemmas about i8051 instructions *)
Add LoadPath "../Model".
Require Import Tacs.
...
Proof. unfold set_reg, same_regs_but, state_same_regs_but; intros.
  ...
  unfold update, i8051Semantics.eq_dec.
...
Proof. unfold set_reg; intros. destruct s'; inv H. simpl.
  unfold update. unfold i8051Semantics.eq_dec, EqDec_register.
