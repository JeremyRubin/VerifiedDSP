...
Section VERIFIER_CORR.
  ...
  *)
  ...
  Opaque Decode.i8051_PARSER.parse_byte.
...
*)
  ...
  *)
  ...
  Transparent Decode.i8051_PARSER.parse_byte.
...
*)
  ...
  Definition includeAllJmpTargets (start:int32) (len:nat) 
    ...
    match (parseloop Decode.i8051_PARSER.initial_parser_state 
